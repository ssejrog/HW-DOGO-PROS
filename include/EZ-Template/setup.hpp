...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {18, -19}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {16, -17}; // Ports, the first number will be used for sensing
...
// Slew
const int FW_SLEW_MIN_POWER = 90; // Starting speed when slew is enabled
const int BW_SLEW_MIN_POWER = 90;
